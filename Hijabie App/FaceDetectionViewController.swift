...
//        previewView2.backgroundColor = .red
    ...
    fileprivate func designatePreviewLayer(for captureSession: AVCaptureSession) {
        ...
        if let previewRootLayer = self.previewView2?.layer {
...
//        let vnImagePoint = VNImagePointForFaceLandmarkPoint(faceLandmarksPath, faceBounds, <#T##imageWidth: Int##Int#>, <#T##imageHeight: Int##Int#>)
