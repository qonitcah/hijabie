//
//  CameraView+Extensions.swift
//  Hijabie App
//
//  Created by Qonitah Faridah on 21/10/23.
//
...
class CameraObjectDetection:  CameraViewController {
    ...
    func setupVision() -> NSError? {
        ...
        guard let modelURL = Bundle.main.url(forResource: "FacialShape", withExtension: "mlmodelc") else {
